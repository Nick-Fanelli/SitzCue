...
#define SITZCUE_PROFILE_OVERRIDE false
...
namespace SitzQ {
	...
	public:
		...
		void BeginSession(const std::string& name, const std::string& filepath = "results.json")
		{
			...
			else
			{
				...
				SITZCUE_ASSERT_MESSAGE(true, "Instrumentor could not open results file!");
			}
		}
	...
	#define SITZCUE_PROFILE_END_SESSION()
	#define SITZCUE_PROFILE_SCOPE(name)
	#define SITZCUE_PROFILE_FUNCTION()
#endif